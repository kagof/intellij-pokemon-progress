...
public enum Pokemon {
    ...
    // Gen II
    CHIKORITA(152, "chikorita", -20, -10, 22, PokemonType.GRASS),
    MEGANIUM(154, "meganium", -16, -3, 28, PokemonType.GRASS),
    CYNDAQUIL(155, "cyndaquil", -14, -12, 20, PokemonType.FIRE),
    TYPHOLSION(157, "typhlosion", -15, -5, 26, PokemonType.FIRE),
    ...
    WOBBUFFET(202, "wobbuffet", -19, -8, 24, PokemonType.PSYCHIC),
    ...
    GLACEON(471, "glaceon", -18, -9, 22, PokemonType.ICE),
    ARCEUS(493, "arceus", -24, 0, 32, PokemonType.NORMAL),
    // Gen V
    SNIVY(495, "snivy", -15, -2, 24, PokemonType.GRASS),
